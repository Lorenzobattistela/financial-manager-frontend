...
class Stock(models.Model):
    ...
    last_update = models.DateTimeField(auto_now=True)
    updated_value = models.DecimalField(max_digits=20, decimal_places=8, default=0)
...
class TreasuryDirect(models.Model):
    ...
    applied_value = models.DecimalField(max_digits=20, decimal_places=8, default=0)
    brute_value = models.DecimalField(max_digits=20, decimal_places=8, default=0)
    liquid_value = models.DecimalField(max_digits=20, decimal_places=8, default=0)
    updated_value = models.DecimalField(max_digits=20, decimal_places=8, default=0)
    last_update = models.DateTimeField(auto_now=True)
